...
function checkAnswer() {
    if (document.getElementById("guess").value.toLowerCase().split(" ").join("") === decrypt(move).toLowerCase().split(" ").join("")) {
        gameStarted = false;
        allHintsRevealed = true;
        document.getElementById("gameText").innerHTML = "You are correct! The answer was <i>" + decrypt(move) + "</i>.";
    } else {
